...
if($_SESSION["cstatus"]=="Administrator"){	
      ...
      <li><a href='home1.php?mnu=admin'>Admin</a></li>
	  <li><a href='home1.php?mnu=datalatih'>Datalatih</a></li>
	  <li><a href='home1.php?mnu=pengujian'>Pengujian</a></li>
      <li><a href='index.php?mnu=logout'>Logout</a></li>";
}
else if($_SESSION["cstatus"]=="User"){	
      echo"
	  <li><a href='home1.php?mnu=home'>Home</a></li>
      <li><a href='home1.php?mnu=profil'>Profil</a></li>
