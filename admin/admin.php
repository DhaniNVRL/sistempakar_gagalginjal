...
<table width="51%" class="table table-striped table-bordered table-hover">
<tr>
<th width="144"><label for="kode_admin">Kode Admin</label>
<th width="10" valign="top">:
<th colspan="2"><b><?php echo $kode_admin;?></b></tr>
<tr>
<td><label for="username">Username</label>
<td valign="top">:<td width="240"><input name="username" type="text" id="username" value="<?php echo $username;?>" size="30" />
</td>
...
<td colspan="2"><input class="btn" name="Simpan" type="submit" id="Simpan" value="Simpan" />
        ...
        <a href="?mnu=admin"><input class="btn" name="Batal" type="button" id="Batal" value="Batal" /></a>
</td></tr>
</table>
</form>
<!-----ACCORDION----->
