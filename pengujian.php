...
else if($mnu=="tanya1"){require_once"tanya1.php";}
else if($mnu=="tanya2"){require_once"tanya2.php";}
else if($mnu=="tanya3"){require_once"tanya3.php";}
else if($mnu=="tanya4"){require_once"tanya4.php";}
else if($mnu=="tanya5"){require_once"tanya5.php";}
else if($mnu=="tanya6"){require_once"tanya6.php";}
else if($mnu=="tanya7"){require_once"tanya7.php";}
else if($mnu=="tanya8"){require_once"tanya8.php";}
else if($mnu=="result"){require_once"result.php";}
